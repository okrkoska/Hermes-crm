...
function LoginScreen({ onLogin, lang, setLang }) {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#EFF6FF", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"-apple-system,'Segoe UI',system-ui,sans-serif" }}>
...
export default function App() {
  ...
  useEffect(() => {
    if (!session) return;
    // Delay initial reactions load by 1.5s so login screen appears instantly
    const delay = setTimeout(() => {
      loadReactions();
      const iv = setInterval(loadReactions, 8000); // poll every 8s instead of 5s
  ...
  return (
    <div style={{ minHeight:"100vh", background:th.bg, color:th.text, fontFamily:"-apple-system,'Segoe UI',system-ui,sans-serif" }}>
      {/* Toast */}
